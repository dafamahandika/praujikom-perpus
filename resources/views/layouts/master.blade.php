...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('admin/img/logo-wk.png') }}" type="img/x-icon" />
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="{{ route('indexUser') }}"><i class="fa-solid fa-users"></i><span>Users</span></a>
              </li>
              
              <li class="nav-item dropdown">
                <a href="{{ route('indexBook') }}"><i class="fa-solid fa-book"></i><span>Books</span></a>
              </li>
        
              <li class="nav-item dropdown">
                <a href="{{ route('indexCategory') }}"><i class="fa-solid fa-book-bookmark"></i><span>Category Book</span></a>
              </li>
            </ul>
        </aside>
      </div>
